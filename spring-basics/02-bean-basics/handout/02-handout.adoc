...
.Folgende Struktur matcht das Wildcard Pattern
* conf
** dao-conf.xml
** service-conf.xml
...
....
<bean id="bookingServiceSingleton" class="org.example.booking.impl.BookingServiceImpl"  scope="singleton">
    ...
</bean>
....
...
....
<bean class="org.example.booking.impl.BookingServiceImpl" id="bookingServicePrototype" scope="prototype">
    ...
</bean>
....
...
_Request_, _session_ and _global session_ scopes are only available if a web-aware ApplicationContext is being used, like XmlWebApplicationContext.
...
== factory-method und FactoryBean interface
